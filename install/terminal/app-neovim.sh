...
tar -xf nvim.tar.gz
sudo install nvim-linux-x84_64/bin/nvim /usr/local/bin/nvim
sudo cp -R nvim-linux-x84_64/lib /usr/local/
sudo cp -R nvim-linux-x84_64/share /usr/local/
rm -rf nvim-linux-x84_64 nvim.tar.gz
cd -
